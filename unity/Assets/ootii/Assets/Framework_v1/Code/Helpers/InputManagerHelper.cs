...
namespace com.ootii.Helpers
{
    ...
    public class InputManagerHelper
    {
        ...
        public static bool IsDefined(string rName)
        {
            ...
            if (!lProperty.Next(true)) { return false; }
            if (!lProperty.Next(true)) { return false; }
        ...
        /// </summary>
        /// <param name="rAxis"></param>
        /// <param name="rIgnoreDuplicates"></param>
        ...
        /// <summary>
        /// Add a keyboard input entry 
        /// </summary>
        /// <param name="rName">Input alias</param>
        /// <param name="rKey">Keyboard key</param>
        /// <param name="rAltKey">Alternate keyboard key</param>
        /// <param name="rGravity"></param>
        /// <param name="rDead"></param>
        /// <param name="rSensitivity"></param>
        /// <param name="rAxis"></param>
        /// <param name="rJoyNum"></param>
        public static InputManagerEntry CreateEntry(string rName, string rKey, string rAltKey = "", float rGravity = 1000f,
            float rDead = 0.001f, float rSensitivity = 1000f, int rAxis = 0, int rJoyNum = 0)
        {
