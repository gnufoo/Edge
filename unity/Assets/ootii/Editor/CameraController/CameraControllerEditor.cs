...
namespace com.ootii.Cameras
{
    ...
    public class CameraControllerEditor : UnityEditor.Editor
    {
        ...
        private void OnEnable()
        {
            ...
            List<Type> lFoundTypes = AssemblyHelper.Instance.FoundTypes;
        ...
        private bool OnAdvancedInspector()
        {
            ...
            if (mTarget.IsZoomEnabled)
            {
                ...
                EditorGUILayout.LabelField(new GUIContent("Range", "The limits that the field-of-view will change to."), GUILayout.Width(lLabelWidth));

                EditorGUILayout.LabelField(new GUIContent("Min", "Minimum zoom field-of-view value."), GUILayout.Width(45f));
                ...
                EditorGUILayout.LabelField(new GUIContent("Max", "Maximum zoom field-of-view value. A value of 0 uses the camera's initial field-of-view property value."), GUILayout.Width(45f));
                ...
                EditorGUILayout.LabelField(new GUIContent("Smoothing", "Speed and smoothness of the field-of-view value changes."), GUILayout.Width(lLabelWidth));

                EditorGUILayout.LabelField(new GUIContent("Zoom", "Multiplier used on the input value to determine how much the field-of-view changes."), GUILayout.Width(45f));
                ...
                EditorGUILayout.LabelField(new GUIContent("Smooth", "Lerp value applied when the camera is moving towards the target field-of-view."), GUILayout.Width(45f));
        ...
        private void SetupScene()
        {
            ...
            IInputSource lInputSource = CreateInputSource(AssemblyHelper.Instance.GetAssemblyQualifiedName("com.ootii.Input.EasyInputSource"));
